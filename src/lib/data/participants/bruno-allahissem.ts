...
const participant: Participant = {
	...
	bio: {
		...
		fr: 'Bruno Allahissem is a PhD candidate in anthropology and history at Leiden University and a member of the Nomadesahel research team (funded by NWO, 406.21.SW.009), based between the Institute for History and the Leiden University Centre for Digital Humanities (LUCDH).'
	}
};
